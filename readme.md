...
Перейдите в папку: `yandex_music_fisher_mod-master/` — именно она будет устанавливаться в браузер.
...
2. Выбери папку `yandex_music_fisher_mod-master/`
...
- Если есть ошибки:
  - Проверь путь: все файлы должны быть внутри `yandex_music_fisher_mod-master/`
